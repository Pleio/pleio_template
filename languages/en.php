...
$english = array(
    ...
    "pleio_template:icon" => "Icon",
    "pleio_template:none" => "None",
    ...
    "pleio_template:newsletter" => "Newsletter",
    ...
    "pleio_template:show_leader_buttons" => "Show buttons on leader",
    "pleio_template:subtitle" => "Leader subtitle",
    ...
    "pleio_template:subgroups" => "Enable subgroups",
