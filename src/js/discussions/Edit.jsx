...
class Edit extends React.Component {
    ...
    render() {
        ...
        return (
            <ActionContainer title="Wijzig een discussie" full={true} noParent={true} onClose={this.onClose}>
                <EditCore subtype="discussion" viewer={viewer} entity={entity} afterEdit={this.afterEdit} onDeleteClick={this.onDeleteClick} />
                <DeleteCore title="Discussie verwijderen" ref="deleteModal" entity={entity} afterDelete={this.afterDelete} />
            </ActionContainer>
        )
    }
}
